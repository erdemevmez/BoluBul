        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneClickCount = table.Column<int>(type: "integer", nullable: false),
                    WhatsAppClickCount = table.Column<int>(type: "integer", nullable: false),
                    DirectionClickCount = table.Column<int>(type: "integer", nullable: false),
                    LastViewedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BusinessStats_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessStats_BusinessId",
                table: "BusinessStats",
                column: "BusinessId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Neighborhoods_DistrictId_Slug",
                table: "Neighborhoods",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_UserId_BusinessId",
                table: "Reviews",
                columns: new[] { "UserId", "BusinessId" },
                unique: true);
        }
